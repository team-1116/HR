...
<link href="lon/css/haiersoft.css" rel="stylesheet" type="text/css" media="screen,print" />
<link href="lon/css/print.css" rel="stylesheet" type="text/css"  media="print" />
<script src="lon/js/jquery-1.10.1.min.js"></script>
<script src="lon/js/side.js" type="text/javascript"></script>
